#!/usr/bin/env python3
"""
Push zh/ja/ko versions of "The Curse of Tutankhamun" to DynamoDB.
...
data_path = os.path.join(script_dir, "curse-tutankhamun-cjk-data.json")
...
# Shared (unchanged) fields from the English original
shared = {
    ...
    "coordinates":        {"lat": Decimal("25.7402"), "lng": Decimal("32.6014")},
