#!/usr/bin/env python3
"""
Push zh/ja versions of "The Secret Chambers" to DynamoDB Story table.
...
data_path = os.path.join(script_dir, "secret-chambers-zh-ja-data.json")
...
# Shared (unchanged) fields — copied from the English record
shared = {
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*50}")
    if all_ok:
        print("BOTH LANGUAGES PUSHED AND VERIFIED SUCCESSFULLY.")
    else:
